...
const { exec } = __nccwpck_require__.e(/* import() */ 514).then(__nccwpck_require__.t.bind(__nccwpck_require__, 1514, 19));
const path = Promise.resolve(/* import() */).then(__nccwpck_require__.t.bind(__nccwpck_require__, 1017, 19));
...
async function run() {
  try {
    ...
    const src = path.resolve(path.join(external_process_namespaceObject.cwd(), core.getInput('src')));
